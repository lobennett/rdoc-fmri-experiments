...
for (var x = 0; x < survey_questions.length; x++) {
  var testTrial = {
    ...
    data: {
      exp_id: 'fagerstrom_survey_rdoc__fmri',
      trial_id: 'test_trial',
    },
    timing_post_trial: 0,
    timing_stim: getTime,
...
var fagerstrom_survey_rdoc__fmri_experiment = [];
fagerstrom_survey_rdoc__fmri_experiment.push(welcome_block);
fagerstrom_survey_rdoc__fmri_experiment.push(instructions_block);
fagerstrom_survey_rdoc__fmri_experiment.push(update_state_block);
fagerstrom_survey_rdoc__fmri_experiment.push(post_questionnaire_node);
fagerstrom_survey_rdoc__fmri_experiment.push(end_block);
