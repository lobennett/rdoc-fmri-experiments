...
var endBlock = {
  ...
  data: {
    trial_id: 'end',
    exp_id: 'dospert_rt_survey_rdoc__fmri',
    trial_duration: 180000,
  },
  trial_duration: 180000,
  stimulus: endText,
...
dospert_rt_survey_rdoc__fmri_experiment = [];
var dospert_rt_survey_rdoc__fmri_init = () => {
  dospert_rt_survey_rdoc__fmri_experiment.push(fullscreen);
  dospert_rt_survey_rdoc__fmri_experiment.push(instructionsBlock);
  dospert_rt_survey_rdoc__fmri_experiment.push(trial);
  dospert_rt_survey_rdoc__fmri_experiment.push(endBlock);
  dospert_rt_survey_rdoc__fmri_experiment.push(exitFullscreen);
};
