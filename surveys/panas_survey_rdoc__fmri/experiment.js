...
var endBlock = {
  ...
  data: {
    trial_id: 'end',
    exp_id: 'panas_survey_rdoc__fmri',
    trial_duration: 180000,
  },
  trial_duration: 180000,
  stimulus: endText,
...
panas_survey_rdoc__fmri_experiment = [];
var panas_survey_rdoc__fmri_init = () => {
  panas_survey_rdoc__fmri_experiment.push(fullscreen);
  panas_survey_rdoc__fmri_experiment.push(instructionsBlock);
  panas_survey_rdoc__fmri_experiment.push(trial);
  panas_survey_rdoc__fmri_experiment.push(endBlock);
  panas_survey_rdoc__fmri_experiment.push(exitFullscreen);
};
