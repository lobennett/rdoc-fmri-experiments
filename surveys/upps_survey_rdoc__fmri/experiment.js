...
upps_survey_rdoc__fmri_experiment = [];
var upps_survey_rdoc__fmri_init = () => {
  upps_survey_rdoc__fmri_experiment.push(fullscreen);
  upps_survey_rdoc__fmri_experiment.push(instructionsBlock);
  upps_survey_rdoc__fmri_experiment.push(trial);
  upps_survey_rdoc__fmri_experiment.push(endBlock);
  upps_survey_rdoc__fmri_experiment.push(exitFullscreen);
};
