...
var fullscreen = {
  ...
  on_finish: async function () {
    ...
    const design_path = `${base}/static/experiments/spatial_cueing_rdoc_practice__fmri/designs`;
...
var expID = 'spatial_cueing_rdoc_practice__fmri';
var endText = `
  <div class="centerbox">
    <p class="center-block-text">Thanks for completing this task!</p>
  </div>`;
...
var spatial_cueing_rdoc_practice__fmri_experiment = [];
var spatial_cueing_rdoc_practice__fmri_init = () => {
  practiceStimuli.push(
    ...sampleWithoutReplacement(doubleCueStim, 1),
    ...sampleWithoutReplacement(noCueStim, 1),
    ...sampleWithoutReplacement(validCueStim, 1),
  ...
  spatial_cueing_rdoc_practice__fmri_experiment.push(
    motor_and_design_perm_block
  );
  spatial_cueing_rdoc_practice__fmri_experiment.push(fullscreen);

  spatial_cueing_rdoc_practice__fmri_experiment.push(practiceNode);
  spatial_cueing_rdoc_practice__fmri_experiment.push(feedbackBlock);
  spatial_cueing_rdoc_practice__fmri_experiment.push(endBlock);
  spatial_cueing_rdoc_practice__fmri_experiment.push(exitFullscreen);
};
