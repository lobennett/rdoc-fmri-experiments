...
var fullscreen = {
  ...
  on_finish: async function () {
    ...
    const design_path = `${base}/static/experiments/visual_search_rdoc_practice__fmri/designs`;
...
var expID = 'visual_search_rdoc_practice__fmri';
var endText = `
...
var visual_search_rdoc_practice__fmri_experiment = [];
var visual_search_rdoc_practice__fmri_init = () => {
  visual_search_rdoc_practice__fmri_experiment.push(
    motor_and_design_perm_block
  );
  visual_search_rdoc_practice__fmri_experiment.push(fullscreen);
  visual_search_rdoc_practice__fmri_experiment.push(practiceNode);
  visual_search_rdoc_practice__fmri_experiment.push(feedbackBlock);
  visual_search_rdoc_practice__fmri_experiment.push(endBlock);
  visual_search_rdoc_practice__fmri_experiment.push(exitFullscreen);
};
