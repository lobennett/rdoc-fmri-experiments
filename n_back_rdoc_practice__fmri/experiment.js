...
const create_conditions = (delay) => {
  ...
  if (delay === 1) {
    conditions.unshift('starter_trial');
  } else if (delay === 2) {
...
var practiceThresh = 4;

// NOTE: Start with 1-back for practice
var delay = 1;
...
const create_practice_trials = (delay) => {
  let practiceTrials = [];
...
var one_back_practice_trials = create_practice_trials(1);
var two_back_practice_trials = create_practice_trials(2);

var one_back_conditional_node_practice = {
  timeline: one_back_practice_trials,
  conditional_function: function () {
...
var two_back_conditional_node_practice = {
  timeline: two_back_practice_trials,
  conditional_function: function () {
...
var practiceNode = {
  timeline: [feedbackBlock].concat(
    one_back_conditional_node_practice,
    two_back_conditional_node_practice
  ),
...
var expID = 'n_back_rdoc_practice__fmri';
var endText = `
...
var n_back_rdoc_practice__fmri_experiment = [];
var n_back_rdoc_practice__fmri_init = () => {
  jsPsych.pluginAPI.preloadImages(images);
  n_back_rdoc_practice__fmri_experiment.push(motor_and_design_perm_block);
  n_back_rdoc_practice__fmri_experiment.push(fullscreen);

  // Start practice
  n_back_rdoc_practice__fmri_experiment.push(practiceNode);
  n_back_rdoc_practice__fmri_experiment.push(feedbackBlock);
  n_back_rdoc_practice__fmri_experiment.push(endBlock);
  n_back_rdoc_practice__fmri_experiment.push(exitFullscreen);
};
