...
var preFileType =
  "<img class = center src='/static/experiments/spatial_task_switching_rdoc_practice__fmri/images/";
...
// IMAGES TO PRELOAD
var pathSource =
  '/static/experiments/spatial_task_switching_rdoc_practice__fmri/images/';
var shapesPreload = [
  'blue_circle',
  'blue_square',
  'orange_circle',
...
var expID = 'spatial_task_switching_rdoc_practice__fmri';
var endText = `
...
spatial_task_switching_rdoc_practice__fmri_experiment = [];

var spatial_task_switching_rdoc_practice__fmri_init = () => {
  jsPsych.pluginAPI.preloadImages(images);
  spatial_task_switching_rdoc_practice__fmri_experiment.push(
    motor_and_design_perm_block
  );
  spatial_task_switching_rdoc_practice__fmri_experiment.push(fullscreen);

  // Practice block
  spatial_task_switching_rdoc_practice__fmri_experiment.push(practiceNode);
  spatial_task_switching_rdoc_practice__fmri_experiment.push(feedbackBlock);
  spatial_task_switching_rdoc_practice__fmri_experiment.push(endBlock);
  spatial_task_switching_rdoc_practice__fmri_experiment.push(exit_fullscreen);
};
