...
var fullscreen = {
  ...
  on_finish: async function () {
    ...
    const design_path = `${base}/static/experiments/stroop_rdoc_practice__fmri/designs`;
...
var expID = 'stroop_rdoc_practice__fmri';
var endText = `
  <div class="centerbox">
...
stroop_rdoc_practice__fmri_experiment = [];
var stroop_rdoc_practice__fmri_init = () => {
  stroop_rdoc_practice__fmri_experiment.push(motor_and_design_perm_block);
  stroop_rdoc_practice__fmri_experiment.push(fullscreen);

  stroop_rdoc_practice__fmri_experiment.push(practiceNode);
  stroop_rdoc_practice__fmri_experiment.push(feedbackBlock);
  stroop_rdoc_practice__fmri_experiment.push(endBlock);
  stroop_rdoc_practice__fmri_experiment.push(exitFullscreen);
};
