...
operation_span_rdoc_practice__fmri_experiment = [];
var operation_span_rdoc_practice__fmri_init = () => {
  operation_span_rdoc_practice__fmri_experiment.push(
    motor_and_design_perm_block
  );
  operation_span_rdoc_practice__fmri_experiment.push(fullscreen);

  // Start practice blocks
  operation_span_rdoc_practice__fmri_experiment.push(practiceNode);
  operation_span_rdoc_practice__fmri_experiment.push(feedbackBlock);
  operation_span_rdoc_practice__fmri_experiment.push(endBlock);
  operation_span_rdoc_practice__fmri_experiment.push(exitFullscreen);
};
