...
var fullscreen = {
  ...
  on_finish: async function () {
    ...
    const design_path = `${base}/static/experiments/go_nogo_rdoc_practice__fmri/designs`;
...
var expID = 'go_nogo_rdoc_practice__fmri';
var endText = `
...
var go_nogo_rdoc_practice__fmri_experiment = [];
var go_nogo_rdoc_practice__fmri_init = () => {
  // globals
  go_nogo_rdoc_practice__fmri_experiment.push(motor_and_design_perm_block);
  go_nogo_rdoc_practice__fmri_experiment.push(fullscreen);

  // practice block
  go_nogo_rdoc_practice__fmri_experiment.push(practiceNode);
  go_nogo_rdoc_practice__fmri_experiment.push(feedbackBlock);
  go_nogo_rdoc_practice__fmri_experiment.push(endBlock);
  go_nogo_rdoc_practice__fmri_experiment.push(exitFullscreen);
};
