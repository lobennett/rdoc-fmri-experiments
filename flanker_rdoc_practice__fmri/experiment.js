...
var preFileType =
  '<img class = center src="/static/experiments/flanker_rdoc_practice__fmri/images/';
...
var pathSource = '/static/experiments/flanker_rdoc_practice__fmri/images/';
var images = [];
...
var fullscreen = {
  ...
  on_finish: async function () {
    ...
    const design_path = `${base}/static/experiments/flanker_rdoc_practice__fmri/designs`;
...
var expID = 'flanker_rdoc_practice__fmri';
var endText = `
...
flanker_rdoc_practice__fmri_experiment = [];
var flanker_rdoc_practice__fmri_init = () => {
  jsPsych.pluginAPI.preloadImages(images);
  // globals
  flanker_rdoc_practice__fmri_experiment.push(motor_and_design_perm_block);
  flanker_rdoc_practice__fmri_experiment.push(fullscreen);

  // practice block
  flanker_rdoc_practice__fmri_experiment.push(practiceNode);
  flanker_rdoc_practice__fmri_experiment.push(feedbackBlock);
  flanker_rdoc_practice__fmri_experiment.push(endBlock);
  flanker_rdoc_practice__fmri_experiment.push(exitFullscreen);
};
